...
7. **Report to the operator:** panel highlights (2-3 verbatim persona quotes), yes/no tally for offers (note which personas SHOULD say no — wrong-fit "no"s are a feature), the 3 variants, scores, and the recommendation.
...
**Panel:** {responded} of {roster} personas — {X yes / Y no} (offers only)
## Key feedback
- {persona}: "{verbatim}"
## Scores
